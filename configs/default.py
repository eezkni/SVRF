...
coarse_model_and_render = dict(
    ...
    fast_color_thres_init=1e-7,   # threshold of alpha value to skip the fine stage sampled point
    fast_color_thres_final=1e-7,
...
fine_model_and_render.update(dict(
    ...
    rgbnet_dim=12,
    alpha_init=1e-2,
    fast_color_thres_init=1e-4,
    fast_color_thres_final=1e-3,
